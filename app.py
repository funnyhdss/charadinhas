...
charadas = [
    ...
    {'id': 5, 'charada':'Qual é a Lua que nunca esta com fome?','resposta':'lua cheia'},
    {'id': 6, 'charada':'O que o aluno fala para a professora e gosta de receber dos pais?','resposta':'presente'},
    {'id': 7, 'charada':'Qual é o céu que não tem estrelas?','resposta':'céu da boca'},
    {'id': 9, 'charada':'O que te pertence, mas as outras pessoas utilizam mais do que você','resposta':'nome'},
